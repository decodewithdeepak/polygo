    ...
    if (allUsers === undefined) {
        return (
            <div className="flex flex-col gap-2 p-3">
                {/* Search bar skeleton */}
                <div className="h-10 animate-pulse rounded-md bg-zinc-800/50" />
            ...
            <div className="p-3">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-md border border-zinc-700 bg-zinc-800/40 py-2 pl-10 pr-4 text-sm text-white placeholder-zinc-500 outline-none transition-all focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500"
                    // pl-10: left padding to make room for the search icon
                    // focus:border-zinc-500: visual feedback when input is focused
                    />
                </div>
            </div>
                    ...
                    <div className="flex flex-col gap-1">
                        {filteredUsers?.map((user) => (
                            <div
                                ...
                                className="flex cursor-pointer items-center gap-3 rounded-lg p-3 transition-colors hover:bg-zinc-800/60"
                            // cursor-pointer: indicates the row is clickable
                            // hover:bg-zinc-800/60: subtle highlight on hover for feedback
